...
/**
 * The messenger icon color can be changed. When it's changed, the messenger app must be closed. This
 * Receiver received the system broadcast that a package has changed, and re-launches messenger.
 */
public class IconColorReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_ICON_COLOR_CHANGED =
            "com.bitblocker.messenger.action.PENDING_PACKAGE_CHANGE";
    ...
    public static final String EXTRA_COMPONENT_NAME =
            "com.bitblocker.messenger.extra.EXTRA_COMPONENT_NAME";
    ...
    public static final String EXTRA_ICON_COLOR_CHANGED =
            "com.bitblocker.messenger.extra.EXTRA_ICON_COLOR_CHANGED";
