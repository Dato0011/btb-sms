package com.bitblocker.messenger.transaction;
...
import com.bitblocker.messenger.common.utils.ImageUtils;
import com.bitblocker.messenger.data.Contact;
import com.bitblocker.messenger.data.ContactHelper;
import com.bitblocker.messenger.data.Message;
import com.bitblocker.messenger.model.ImageModel;
import com.bitblocker.messenger.model.SlideshowModel;
import com.bitblocker.messenger.receiver.RemoteMessagingReceiver;
...
public class NotificationManager {
    ...
    public static final String ACTION_MARK_READ = "com.bitblocker.messenger.MARK_READ";
    public static final String ACTION_MARK_SEEN = "com.bitblocker.messenger.MARK_SEEN";
                    ...
                    if (conversationPrefs.getTickerEnabled()) {
                        switch (privateNotifications) {
                            ...
                            case 1:
                                ...
                                break;
                            case 2:
                                builder.setTicker(String.format("%s: %s", "messenger", sRes.getString(R.string.new_message)));
                                break;
                        }
                    }
                ...
                for (Message message : SmsHelper.getFailedMessages(context)) {
                    switch (Integer.parseInt(sPrefs.getString(SettingsFragment.PRIVATE_NOTIFICATION, "0"))) {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            inboxStyle.addLine(Html.fromHtml("<strong>" + "messenger" + "</strong> " + sRes.getString(R.string.new_message)));
                            break;
                    }
                }
    ...
    private static void singleSender(final Context context, ArrayList<MessageItem> messages, long threadId,
        ...
        if (privateNotifications == 2) notificationTitle = "messenger";
