...
package com.bitblocker.messenger.mmssms;
...
public class Transaction {
    ...
    public static final String MMS_ERROR = "com.bitblocker.messenger.send_message.MMS_ERROR";
    public static final String REFRESH = "com.bitblocker.messenger.send_message.REFRESH";
    public static final String MMS_PROGRESS = "com.bitblocker.messenger.send_message.MMS_PROGRESS";
    public static final String VOICE_FAILED = "com.bitblocker.messenger.send_message.VOICE_FAILED";
    public static final String VOICE_TOKEN = "com.bitblocker.messenger.send_message.RNRSE";
    public static final String NOTIFY_OF_DELIVERY = "com.bitblocker.messenger.send_message.NOTIFY_DELIVERY";
    public static final String NOTIFY_OF_MMS = "com.bitblocker.messenger.messaging.NEW_MMS_DOWNLOADED";
