...
import com.bitblocker.messenger.common.utils.PhoneNumberUtils;
...
import com.bitblocker.messenger.interfaces.RecipientProvider;
...
public class ComposeView extends LinearLayout implements View.OnClickListener {
    ...
    public void sendSms() {
        ...
        if (recipients != null && recipients.length > 0) {
            ...
            com.bitblocker.messenger.mmssms.Message message = new com.bitblocker.messenger.mmssms.Message(body, recipients);
