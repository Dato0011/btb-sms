...
import com.bitblocker.messenger.common.formatter.FormatterFactory;
import com.bitblocker.messenger.common.google.ItemLoadedCallback;
import com.bitblocker.messenger.common.google.ItemLoadedFuture;
import com.bitblocker.messenger.common.google.PduLoaderManager;
import com.bitblocker.messenger.common.utils.AddressUtils;
...
public class MessageItem {
    ...
    public MessageItem(Context context, String type, final Cursor cursor,
        ...
        if ("sms".equals(type)) {
            ...
            mItemLoadedFuture = BTBMessengerApp.getApplication().getPduLoaderManager()
