package com.bitblocker.messenger.ui.dialog.mms;
...
import com.bitblocker.messenger.mmssms.Settings;
import com.bitblocker.messenger.transaction.SmsHelper;
import com.bitblocker.messenger.ui.base.QKFragment;

import java.util.List;

import static com.bitblocker.messenger.ui.dialog.mms.MMSDialogFragment.DISMISS_RESULT;
import static com.bitblocker.messenger.ui.dialog.mms.MMSDialogFragment.DialogFragmentListener;
import static com.bitblocker.messenger.ui.dialog.mms.MMSDialogFragment.LIST_ITEM_CLICK_RESULT;
import static com.bitblocker.messenger.ui.dialog.mms.MMSDialogFragment.NEGATIVE_BUTTON_RESULT;
import static com.bitblocker.messenger.ui.dialog.mms.MMSDialogFragment.NEUTRAL_BUTTON_RESULT;
import static com.bitblocker.messenger.ui.dialog.mms.MMSDialogFragment.POSITIVE_BUTTON_RESULT;
...
public class MMSSetupFragment extends QKFragment implements DialogFragmentListener {
    ...
    private static String getSupportEmailBody(Context context) {
        if (context != null) {
            ...
            body.append("Press send, and the messenger team will find the correct MMS settings for you!\n\n");
