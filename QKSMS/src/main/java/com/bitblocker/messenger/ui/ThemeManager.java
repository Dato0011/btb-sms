package com.bitblocker.messenger.ui;
...
import com.bitblocker.messenger.common.utils.Units;
import com.bitblocker.messenger.enums.QKPreference;
import com.bitblocker.messenger.receiver.IconColorReceiver;
import com.bitblocker.messenger.theme.IconAdapter;
import com.bitblocker.messenger.ui.base.QKActivity;
import com.bitblocker.messenger.ui.dialog.ColorPickerPagerAdapter;
import com.bitblocker.messenger.ui.dialog.QKDialog;
import com.bitblocker.messenger.ui.settings.SettingsFragment;
import com.bitblocker.messenger.ui.view.QKEditText;
import com.bitblocker.messenger.ui.view.QKTextView;
import com.bitblocker.messenger.ui.view.colorpicker.ColorPickerPalette;
    ...
    public static void setIcon(final QKActivity context) {
        ...
        recyclerView.setAdapter(new IconAdapter(context, (parent, view, position, id) -> {
            ...
            for (int i = 0; i < colors.length; i++) {
                String componentClassName = String.format("com.bitblocker.messenger.ui.MainActivity-%s", colors[i]);
            ...
            // 2) relaunch messenger with the new component name.
